  ...
  if (req.isAuthenticated()) {
    try {
      ...
      if (secret) {
        ...
        res.render("secrets.ejs", { secret: "You should submit your secret!" });
      }
    } catch (error) {
      console.log(error);
    }

    //to pull in the user secret to render in secrets.ejs
  } else {
    res.redirect("/login");
  }
});
...
// the logic should work with authentication.
